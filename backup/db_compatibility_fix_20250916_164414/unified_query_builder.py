...
class UnifiedQueryBuilder:
    ...
    def build_industry_list_query(self) -> str:
        """构建行业列表查询"""
        industry_field = self.field_mapper.get_database_field('industry', self.db_type)
    ...
    def build_stock_list_query(self, industry: Optional[str] = None,
        ...
        conditions = []
        if industry:
            conditions.append(QueryCondition('industry', '=', industry))
