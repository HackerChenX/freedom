...
class EnhancedRSI(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin):
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        Returns:
            包含Enhanced RSI指标的DataFrame
        """
        return self.calculate_Rsi(data, **kwargs)

    def _get_default_parameters_enhancedrsi(self) -> dict:
        """
        获取Enhanced RSI指标的默认参数
    ...
    def _calculate_baseindicator(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        Returns:
            包含Enhanced RSI指标的DataFrame
        """
        return self._calculate_enhancedrsi(data)
    ...
    def calculate_confidence_Indicator_Base_Indicator(self, score: pd.Series, patterns: pd.DataFrame, signals: dict) -> float:
        ...
        Returns:
            float: 置信度分数 (0-1)
        """
        return self.calculate_confidence_Enhanced_Rsi(score, patterns, signals)
    ...
    def calculate_raw_score_Indicator_Base_Indicator(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        Returns:
            pd.Series: 原始评分序列
        """
        return self.calculate_raw_score_Enhanced_Rsi(data, **kwargs)
    ...
    def get_patterns_Indicator_Base_Indicator(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        """
        return self.get_patterns_Enhanced_Rsi(data, **kwargs)
