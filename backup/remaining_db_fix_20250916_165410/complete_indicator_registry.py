...
class CompleteIndicatorRegistry:
    ...
    def _register_zxm_indicators(self) -> int:
        ...
        zxm_indicators = {
            ...
            'ZXM_INDUSTRY_ROTATION': 'indicators.zxm.industry_rotation_indicators.ZXMIndustryRotation',  # 修复路径
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            logger.error(f"指标 {name} 实例化完全失败: 无参数失败, period=20失败, n=9,m1=3,m2=3失败")
                            return None
