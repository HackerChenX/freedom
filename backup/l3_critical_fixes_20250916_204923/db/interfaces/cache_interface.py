...
class ICacheService(ABC):
    ...
    @abstractmethod
    def get__list_Interface(self) -> Optional[List[Dict[str, Any]]]:
        """获取行业列表"""
        pass
    
    @abstractmethod
    def set__list_Interface(self, data: List[Dict[str, Any]]) -> bool:
        """设置行业列表"""
        pass
    
    @abstractmethod
    def get__stocks_Interface(self, _code: str) -> Optional[List[str]]:
        """获取行业股票列表"""
        pass
    
    @abstractmethod
    def set__stocks_Interface(self, _code: str, stocks: List[str]) -> bool:
        """设置行业股票列表"""
        pass
