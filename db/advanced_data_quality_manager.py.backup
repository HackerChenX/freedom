...
class AdvancedDataQualityManager:
    ...
    def __init__(self):
        ...
        self.anomaly_thresholds = {
            'price_change_limit': 0.2,      # 单日涨跌幅限制20%
    ...
    def _detect_price_anomalies(self, stock_data: pd.DataFrame) -> List[DataQualityIssue]:
        ...
        extreme_changes = stock_data[
            abs(stock_data['price_change']) > self.anomaly_thresholds['price_change_limit']
        ]
        ...
        if not extreme_changes.empty:
            ...
            issues.append(DataQualityIssue(
                ...
                details={
                    ...
                    'extreme_changes': extreme_changes[['date', 'close', 'price_change']].to_dict('records')[:5]
                }
            ))
