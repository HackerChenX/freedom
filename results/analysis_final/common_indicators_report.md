...
| indicator | KDJ | KDJ超买 | KDJ值高于80，表示超买状态 | 100.0% | 1 | 50.0 |
...
#### 🎯 高命中率指标 (≥80%)
- **VOL** (放量上涨): 100.0%命中率，平均得分70.0分
  *成交量显著放大，同时价格上涨，通常是趋势启动或加速的信号*
- **SAR** (上升趋势): 100.0%命中率，平均得分50.0分
  *SAR指标显示上升趋势*
...
- **BOLL** (布林带上轨突破): 100.0%命中率，平均得分70.0分
  *价格突破布林带上轨，表明强势上涨*
- **VOL** (均量线多头排列): 100.0%命中率，平均得分70.0分
  *成交量均线呈多头排列，表示成交量趋势强劲*
- **SAR** (Sar Close To Price): 100.0%命中率，平均得分50.0分
  *SAR_CLOSE_TO_PRICE形态*
- **SAR** (Sar Low Acceleration): 100.0%命中率，平均得分50.0分
  *SAR_LOW_ACCELERATION形态*
