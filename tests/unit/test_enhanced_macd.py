...
class Testenhancedmacd_macd(unittest.TestCase, IndicatorTestMixin, LogCaptureMixin):
    """EnhancedMACD指标测试类"""
    ...
    def setUp(self):
        ...
        self.indicator = complete_registry.create_indicator('EnhancedMACD', fast_period=12, slow_period=26, signal_period=9)
