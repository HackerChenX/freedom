...
class Test_unified_mA(unittest.TestCase, IndicatorTestMixin, LogCaptureMixin):
    """UnifiedMA指标测试类"""
    ...
    def setUp(self):
        ...
        self.indicator = complete_registry.create_indicator('MA', periods=[5, 10, 20], ma_type='simple')
