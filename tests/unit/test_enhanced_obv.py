...
class Test_enhanced_oBV(unittest.TestCase, IndicatorTestMixin, LogCaptureMixin):
    """EnhancedOBV指标测试类"""
    ...
    def setUp(self):
        ...
        self.indicator = complete_registry.create_indicator('OBV', ma_period=30, multi_periods=[5, 10, 20, 60])
