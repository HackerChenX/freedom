...
class Testkc_kc(unittest.Test_case, Indicator_test_mixin, Log_capture_mixin):
    """KC指标测试类"""
    ...
    def test_kc_parameter_update(self):
        ...
        self.assert_equal(self.indicator.atr_period, new_atr_period)
        self.assert_equal(self.indicator.multiplier, new_multiplier)
    ...
    def test_no_errors_during_calculation_Kc(self):
        """测试计算过程中无ERROR日志"""
        self.clear_logs()
    ...
    def test_no_errors_during_pattern_detection_Kc(self):
        """测试形态检测过程中无ERROR日志"""
        self.clear_logs()
