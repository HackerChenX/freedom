...
class Testmtm_mtm(unittest.Test_case, Indicator_test_mixin, Log_capture_mixin):
    """MTM指标测试类"""
    
    def set_up_Mtm(self):
        """设置测试环境"""
        # 显式调用LogCaptureMixin的setUp
        Log_capture_mixin.set_up_Mtm(self)
    ...
    def tear_down_Mtm(self):
        """清理日志捕获器"""
        Log_capture_mixin.tear_down_Mtm(self)
    ...
    def test_no_errors_during_pattern_detection_Mtm(self):
        """测试形态检测过程中无ERROR日志"""
        self.clear_logs()
