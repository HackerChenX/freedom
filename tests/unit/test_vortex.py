...
class Testvortex_vortex(unittest.Test_case, Indicator_test_mixin, Log_capture_mixin):
    """Vortex指标测试类"""
    
    def set_up_Vortex(self):
        """设置测试环境"""
        # 显式调用LogCaptureMixin的setUp
        Log_capture_mixin.set_up_Vortex(self)
    ...
    def tear_down_Vortex(self):
        """清理日志捕获器"""
        Log_capture_mixin.tear_down_Vortex(self)
    ...
    def test_vortex_patterns_Vortex(self):
        """测试Vortex形态识别"""
        # 先计算指标
        result = self.indicator.calculate(self.data)
    ...
    def test_vortex_signals_Vortex(self):
        """测试Vortex信号生成"""
    ...
    def test_no_errors_during_calculation_Vortex(self):
        """测试计算过程中无ERROR日志"""
        self.clear_logs()
    ...
    def test_no_errors_during_pattern_detection_Vortex(self):
        """测试形态检测过程中无ERROR日志"""
        self.clear_logs()
