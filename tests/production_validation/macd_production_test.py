...
from db.sql_manager import SQLManager, QueryType
    ...
    def _stage1_simulated_data_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # 计算平均得分 - 严格要求100%成功率
            if macd_patterns:
                result['score'] = total_score / len(macd_patterns)
                result['success'] = successful_patterns == len(macd_patterns)  # 100%通过率要求
            
            result['details'] = {
                'total_patterns': len(macd_patterns),
                'successful_patterns': successful_patterns,
                'success_rate': successful_patterns / len(macd_patterns) if macd_patterns else 0
            }
    ...
    def _test_single_pattern_comprehensive(self, pattern_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 2. 形态识别测试
            patterns_result = self.macd.get_patterns(correct_data)
            ...
            result['success'] = result['score'] == 1.0  # 100%通过率要求
