...
def quick_momentum_test_adjusted():
    """快速测试MOMENTUM指标（调整后的验证标准）"""
    print("🚀 MOMENTUM指标调整后的验证测试")
    print("=" * 50)
    ...
    try:
        ...
        print(f"  - 继承链: {[cls.__name__ for cls in momentum.__class__.__mro__[:5]]}")
...
if __name__ == "__main__":
    success, details = quick_momentum_test_adjusted()
