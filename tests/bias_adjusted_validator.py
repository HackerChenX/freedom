...
def quick_bias_test_adjusted():
    """快速测试BIAS指标（调整后的验证标准）"""
    print("🚀 BIAS指标调整后的验证测试")
    print("=" * 50)
    
    try:
        # 使用BIAS指标
        from indicators.bias import BiasBias
        ...
        print(f"  - 继承链: {[cls.__name__ for cls in bias.__class__.__mro__[:5]]}")
...
if __name__ == "__main__":
    success, details = quick_bias_test_adjusted()
