...
def main_testmaperfect():
    ...
    try:
        results = validator.validate_ma_patterns_perfect()
        ...
        output_file = f"perfect_validation_results_MA_{timestamp}.json"
