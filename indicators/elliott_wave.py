...
class ELLIOTT_WAVE(BaseIndicator, PatternSignalMixin):
    ...
    def _calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        df[f'ELLIOTT_WAVE_VALUE'] = df['close'].rolling(window=self.period).mean()
        ...
        df.loc[:, 'buy_signal'] = df[f'ELLIOTT_WAVE_VALUE'] >= score_threshold
        df.loc[:, 'sell_signal'] = df[f'ELLIOTT_WAVE_VALUE'] < score_threshold
        df.loc[:, 'hold_signal'] = df[f'ELLIOTT_WAVE_VALUE'] < score_threshold
