...
def linregress(x, y):
    ...
    return type(
        ...
        (),
        {
            ...
            "rvalue": rvalue,
            "pvalue": (
                0.05 if abs(rvalue) > 0.5 else 0.5
            ),  # 简化的p值  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            "stderr": 0.0,
        },
    )()
...
class ZxmdailyTrendUp(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin, ZXMAbstractMethodsMixin):
    ...
    def _calculate_trendindicators(self, data: pd.DataFrame, *args, **kwargs) -> pd.DataFrame:
        ...
        公式说明：
        j1:MA(C,60)>=REF(MA(C,60),1);  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        j2:MA(C,120)>=REF(MA(C,120),1);  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        xg:j1 OR j2;
        """
        # 确保数据包含必需的列
    ...
    def calculate_raw_score_Indicators_trendindicators(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        # 初始化评分为基础分50分（中性）
        scores = pd.Series(50.0, index=data.index, dtype=float)  # TODO: 将魔法数字提取到配置中
        ...
        for i in range(len(data)):
            ...
            if i >= 5:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                # 短期价格趋势
                price_trend_5 = (
                    (current_close - close.iloc[i - 5]) / close.iloc[i - 5] if close.iloc[i - 5] > 0 else 0
                )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                if price_trend_5 > 0.05:  # 5日涨幅>5%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score += 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif price_trend_5 > 0.02:  # 5日涨幅>2%
                    score += 10
                elif price_trend_5 > 0:  # 5日涨幅>0%
                    score += 5  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif (
                    price_trend_5 < -0.05
                ):  # 5日跌幅>5%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score -= 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            ...
            if i >= 10:
                price_trend_10 = (
                    (current_close - close.iloc[i - 10]) / close.iloc[i - 10] if close.iloc[i - 10] > 0 else 0
                )
                if price_trend_10 > 0.10:  # 10日涨幅>10%
                    score += 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif (
                    price_trend_10 > 0.05
                ):  # 10日涨幅>5%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score += 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif price_trend_10 > 0:  # 10日涨幅>0%
                    score += 8  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif price_trend_10 < -0.10:  # 10日跌幅>10%
                    score -= 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif (
                    price_trend_10 < -0.05
                ):  # 10日跌幅>5%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score -= 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif price_trend_10 < 0:  # 10日跌幅>0%
                    score -= 8  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

            # 3. 基于20日趋势的评分  # TODO: 将魔法数字提取到配置中
            if i >= 20:  # TODO: 将魔法数字提取到配置中
                price_trend_20 = (
                    (current_close - close.iloc[i - 20]) / close.iloc[i - 20] if close.iloc[i - 20] > 0 else 0
                )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                if (
                    price_trend_20 > 0.20
                ):  # 20日涨幅>20%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score += 25  # TODO: 将魔法数字提取到配置中
                    ...
                    price_trend_20 < -0.20
                ):  # 20日跌幅>20%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score -= 25  # TODO: 将魔法数字提取到配置中
            ...
            # 4. 如果有MA60数据，使用MA60评分  # TODO: 将魔法数字提取到配置中
            if i >= 60 and not pd.isna(ma60.iloc[i]):  # TODO: 将魔法数字提取到配置中
                current_ma60 = ma60.iloc[i]

                # 价格相对MA60位置
                if current_close > current_ma60 * 1.05:  # 价格在MA60上方5%以上  # TODO: 将魔法数字提取到配置中
                    score += 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif current_close > current_ma60:  # 价格在MA60上方
                    score += 10
                elif current_close > current_ma60 * 0.98:  # 价格接近MA60（2%以内）  # TODO: 将魔法数字提取到配置中
                    score += 5  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif current_close < current_ma60 * 0.95:  # 价格在MA60下方5%以上  # TODO: 将魔法数字提取到配置中
                    score -= 10
                elif current_close < current_ma60:  # 价格在MA60下方
                    score -= 5  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

                # MA60趋势
                if i >= 65:  # TODO: 将魔法数字提取到配置中
                    ma60_trend = (
                        (current_ma60 - ma60.iloc[i - 5]) / ma60.iloc[i - 5] if ma60.iloc[i - 5] > 0 else 0
                    )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            ...
            # 5. 如果有MA120数据，使用MA120评分  # TODO: 将魔法数字提取到配置中
            if i >= 120 and not pd.isna(ma120.iloc[i]):  # TODO: 将魔法数字提取到配置中
                ...
                if current_close > current_ma120 * 1.10:  # 价格在MA120上方10%以上
                    ...
                    current_close > current_ma120 * 0.95
                ):  # 价格接近MA120（5%以内）  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score += 8  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif current_close < current_ma120 * 0.90:  # 价格在MA120下方10%以上  # TODO: 将魔法数字提取到配置中
                    score -= 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif current_close < current_ma120:  # 价格在MA120下方
                    score -= 10

                # MA120趋势
                if i >= 125:  # TODO: 将魔法数字提取到配置中
                    ma120_trend = (
                        (current_ma120 - ma120.iloc[i - 5]) / ma120.iloc[i - 5] if ma120.iloc[i - 5] > 0 else 0
                    )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            ...
            if i >= 10:
                ...
                if volatility < 0.02:  # 日波动率<2%
                    score += 5  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif volatility < 0.03:  # 日波动率<3%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score += 3  # TODO: 将魔法数字提取到配置中
                elif volatility > 0.08:  # 日波动率>8%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score -= 8  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                elif volatility > 0.05:  # 日波动率>5%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    score -= 5  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

            # 7. 连续性评分  # TODO: 将魔法数字提取到配置中
            if i >= 5:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                # 连续上涨天数
                consecutive_up = 0
                for j in range(min(5, i)):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    if close.iloc[i - j] > close.iloc[i - j - 1]:
                        consecutive_up += 1
                    else:
                        break

                if consecutive_up >= 3:  # TODO: 将魔法数字提取到配置中
                ...
                if consecutive_down >= 3:  # TODO: 将魔法数字提取到配置中
    ...
    def identify_patterns_Indicators_trendindicators(self, data: pd.DataFrame, **kwargs) -> List[str]:
        ...
        if len(result) > 0:
            ...
            if len(result) >= 10:
                if (
                    not result["XG"].iloc[-10:-5].any() and result["XG"].iloc[-5:].all()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    patterns.append("趋势由弱转强")
                elif (
                    result["XG"].iloc[-10:-5].all() and not result["XG"].iloc[-5:].any()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
    ...
    def generate_signals_Indicators_trendindicators(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        # 置信度设置
        signals.loc[:, "confidence"] = 60  # 基础置信度  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        # 双均线上移，置信度更高
        signals.loc[result["XG"] & result["J1"] & result["J2"], "confidence"] = 80  # TODO: 将魔法数字提取到配置中
        # 评分高的信号，置信度更高
        signals.loc[score > 70, "confidence"] = 75  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        signals.loc[score > 85, "confidence"] = 90  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        ...
        signals.loc[result["XG"], "position_size"] = 0.3  # 基础仓位  # TODO: 将魔法数字提取到配置中
        signals.loc[(result["XG"]) & (score > 70), "position_size"] = (
            0.5  # 高分仓位  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        )
        signals.loc[(result["XG"]) & (score > 85), "position_size"] = (
            0.7  # 极高分仓位  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        )
        ...
        for i in data.index[mask]:
            ...
            if close_val > ma60_val:
                signals.loc[i, "stop_loss"] = ma60_val * 0.98  # 均线下方2%  # TODO: 将魔法数字提取到配置中
            else:
                # 否则使用近期低点
                try:
    ...
    def calculate_confidence_Indicators_trendindicators(
        ...
        if "双均线上移" in patterns:
            pattern_boost += 0.15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
    ...
    def get_patterns_Indicators_trendindicators(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        if len(result) >= 10:
            ...
            for i in range(10, len(result)):
                if (
                    not result["XG"].iloc[i - 10 : i - 5].any() and result["XG"].iloc[i - 5 : i + 1].all()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    trend_weak_to_strong.iloc[i] = True
                elif (
                    result["XG"].iloc[i - 10 : i - 5].all() and not result["XG"].iloc[i - 5 : i + 1].any()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
...
class ZxmweeklyTrendUp(BaseIndicator, PatternSignalMixin):
    ...
    def calculate_raw_score_Indicators_trendindicators_duplicate(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        # 初始化评分为基础分50分（中性）
        score = pd.Series(50, index=data.index)  # TODO: 将魔法数字提取到配置中

        # 主要信号评分规则
        # 1. 均线上移信号(XG)：周线级别上看涨，+30分
        score[result["XG"]] += 30  # TODO: 将魔法数字提取到配置中

        # 2. 不同周期均线上移组合评分
        # 三均线同时上移是最强信号
        all_up = result["A1"] & result["B1"] & result["C1"]
        score[all_up] += 15  # TODO: 将魔法数字提取到配置中
        ...
        score[only_ma10_up] += 5  # 短期均线上移  # TODO: 将魔法数字提取到配置中
        score[only_ma20_up] += 10  # 中期均线上移
        score[only_ma30_up] += 15  # 长期均线上移  # TODO: 将魔法数字提取到配置中

        # 3. 价格与均线位置关系评分  # TODO: 将魔法数字提取到配置中
        price_above_ma10 = data["close"] > result["MA10"]
        price_above_ma20 = data["close"] > result["MA20"]
        price_above_ma30 = data["close"] > result["MA30"]

        # 价格在均线上方，趋势更强
        score[price_above_ma10] += 5  # TODO: 将魔法数字提取到配置中
        score[price_above_ma20] += 8  # TODO: 将魔法数字提取到配置中
        score[price_above_ma30] += 12  # TODO: 将魔法数字提取到配置中

        # 4. 均线多头排列评分  # TODO: 将魔法数字提取到配置中
        ...
        score[ma_bull_alignment] += 15  # 多头排列加分  # TODO: 将魔法数字提取到配置中
        score[ma_bear_alignment] -= 15  # 空头排列减分  # TODO: 将魔法数字提取到配置中

        # 5. 连续上移评分  # TODO: 将魔法数字提取到配置中
        # 连续多周均线上移，表示趋势较强
        continuous_up_weeks = pd.Series(0, index=data.index)
        for i in range(4, len(data)):  # TODO: 将魔法数字提取到配置中
            if all(result["XG"].iloc[i - 4 : i + 1]):  # TODO: 将魔法数字提取到配置中
                continuous_up_weeks.iloc[i] = 4  # TODO: 将魔法数字提取到配置中
            elif all(result["XG"].iloc[i - 2 : i + 1]):
                continuous_up_weeks.iloc[i] = 2

        # 根据连续上移周数加分
        score[continuous_up_weeks == 2] += 5  # TODO: 将魔法数字提取到配置中
        score[continuous_up_weeks == 4] += 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

        # 6. 均线角度评分  # TODO: 将魔法数字提取到配置中
        # 计算均线斜率
        ma10_slope = result["MA10"].diff(4) / result["MA10"].shift(
            4
        )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        ma20_slope = result["MA20"].diff(4) / result["MA20"].shift(
            4
        )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        ma30_slope = result["MA30"].diff(4) / result["MA30"].shift(
            4
        )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        ...
        score[
            ma10_slope > 0.03
        ] += 5  # 月涨幅>3%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        score[
            ma10_slope > 0.06
        ] += 5  # 月涨幅>6%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

        score[ma20_slope > 0.02] += 5  # 月涨幅>2%  # TODO: 将魔法数字提取到配置中
        score[
            ma20_slope > 0.04
        ] += 5  # 月涨幅>4%  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中

        score[ma30_slope > 0.01] += 5  # 月涨幅>1%  # TODO: 将魔法数字提取到配置中
        score[ma30_slope > 0.02] += 5  # 月涨幅>2%  # TODO: 将魔法数字提取到配置中
    ...
    def identify_patterns_Indicators_trendindicators_duplicate(self, data: pd.DataFrame, **kwargs) -> List[str]:
        ...
        if len(result) > 0:
            ...
            # 近期趋势变化
            if len(result) >= 8:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                if (
                    not result["XG"].iloc[-8:-4].any() and result["XG"].iloc[-4:].all()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    patterns.append("周线趋势由弱转强")
                elif (
                    result["XG"].iloc[-8:-4].all() and not result["XG"].iloc[-4:].any()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
    ...
    def generate_signals_Indicators_trendindicators_duplicate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        # 风险等级
        signals.loc[:, "risk_level"] = "中"  # 默认中等风险
        signals.loc[score >= 75, "risk_level"] = "低"  # TODO: 将魔法数字提取到配置中
        signals.loc[score <= 30, "risk_level"] = "高"  # TODO: 将魔法数字提取到配置中
        ...
        signals.loc[three_ma_up, "position_size"] = 0.5  # 三均线上移，加大仓位  # TODO: 将魔法数字提取到配置中
        signals.loc[three_ma_up & ma_bull_alignment, "position_size"] = (
            0.7  # 三均线上移且多头排列，大仓位  # TODO: 将魔法数字提取到配置中
        )
        ...
        for i in signals.index[signals["buy_signal"]]:
            ...
            if close_val > ma10_val:
                signals.loc[i, "stop_loss"] = ma10_val * 0.95  # 10周均线下方5%  # TODO: 将魔法数字提取到配置中
            elif close_val > ma20_val:
                signals.loc[i, "stop_loss"] = ma20_val * 0.95  # 20周均线下方5%  # TODO: 将魔法数字提取到配置中
            else:
                # 否则使用近期低点
                try:
                    idx = data.index.get_loc(i)
                    if idx >= 8:  # TODO: 将魔法数字提取到配置中
                        low_price = data.iloc[idx - 8 : idx + 1]["low"].min()  # TODO: 将魔法数字提取到配置中
                        signals.loc[i, "stop_loss"] = low_price * 0.95  # 最低点下方5%  # TODO: 将魔法数字提取到配置中
                except:
                    continue
    ...
    def calculate_confidence_Indicators_trendindicators_duplicate(
        self, score: pd.Series, patterns: List[str], signals: Dict[str, pd.Series]
    ) -> float:
        """
        计算置信度
    ...
    def get_patterns_Indicators_trendindicators_duplicate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        patterns_df.loc[:, "价格站上三均线"] = (
            price_above_ma10 & price_above_ma20 & price_above_ma30 & ma_bull_alignment
        )
        ...
        if len(result) >= 8:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            ...
            for i in range(8, len(result)):  # TODO: 将魔法数字提取到配置中
                if (
                    not result["XG"].iloc[i - 8 : i - 4].any() and result["XG"].iloc[i - 4 : i + 1].all()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    trend_weak_to_strong.iloc[i] = True
                elif (
                    result["XG"].iloc[i - 8 : i - 4].all() and not result["XG"].iloc[i - 4 : i + 1].any()
                ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                    trend_strong_to_weak.iloc[i] = True
    ...
    def register_patterns_Indicators_Trend_Indicators_Trend_Indicators_trendindicators_duplicate(self):
        ...
        self.register_pattern_to_registry(
            ...
            score_impact=35.0,  # TODO: 将魔法数字提取到配置中
            polarity="POSITIVE",
        )
...
class ZxmmonthlyMacd(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin, ZXMAbstractMethodsMixin):
    ...
    def __init__(self):
        ...
        self.short_period = 12  # TODO: 将魔法数字提取到配置中
        self.long_period = 26  # TODO: 将魔法数字提取到配置中
        self.signal_period = 9  # TODO: 将魔法数字提取到配置中
    ...
    def minimum_periods(self) -> int:
        ...
        Returns:
            int: 最少需要的数据周期数
        """
        return 60  # 月线MACD需要更多数据  # TODO: 将魔法数字提取到配置中
    ...
    def calculate_confidence_Indicator_Base_Indicator(
        ...
        Returns:
            float: 置信度分数 (0-1)
        """
        return 0.85  # ZXM月线MACD置信度较高  # TODO: 将魔法数字提取到配置中
    ...
    def calculate_raw_score_Indicator_Base_Indicator(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        if "DIF" in result.columns and "DEA" in result.columns:
            ...
            score[golden_cross] = 30.0  # 月线金叉权重更高  # TODO: 将魔法数字提取到配置中
            score[death_cross] = -30.0  # TODO: 将魔法数字提取到配置中

            # 强势多头/空头信号
            strong_bullish = (dif > 0) & (dea > 0) & (result["MACD"] > 0)
            strong_bearish = (dif < 0) & (dea < 0) & (result["MACD"] < 0)

            score[strong_bullish] = 20.0  # TODO: 将魔法数字提取到配置中
            score[strong_bearish] = -20.0  # TODO: 将魔法数字提取到配置中
    ...
    def set_parameters_Indicator_Base_Indicator(self, **kwargs):
        ...
        Args:
            **kwargs: 参数字典
        """
        self.short_period = kwargs.get("short_period", 12)  # TODO: 将魔法数字提取到配置中
        self.long_period = kwargs.get("long_period", 26)  # TODO: 将魔法数字提取到配置中
    ...
    def _get_default_parameters_zxmmonthlymacd(self) -> dict:
        ...
        """
        return {
            "short_period": 12,  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            "long_period": 26,  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            "signal_period": 9,  # TODO: 将魔法数字提取到配置中
        }
...
class ZxmweeklyMacd(BaseIndicator, PatternSignalMixin):
    ...
    def _calculate_divergence_Trend_Indicators(self, data: pd.DataFrame) -> None:
        ...
        # 寻找价格和DIF的低点和高点
        window = 8  # 用于寻找局部极值的窗口大小  # TODO: 将魔法数字提取到配置中
    ...
    def _calculate_trend_stability(self, result: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            # 计算趋势稳定性
            lookback = 5  # 回看窗口  # TODO: 将魔法数字提取到配置中
    ...
    def get_pattern_info_Indicators_Trend_Indicators_Trend_Indicators_trendindicators_duplicate(
        self, pattern_id: str
    ) -> dict:
        """
        获取指定形态的详细信息
    ...
    def minimum_periods(self) -> int:
        ...
        Returns:
            int: 最少需要的数据周期数
        """
        return 50  # 周线MACD需要更多数据  # TODO: 将魔法数字提取到配置中
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        # 计算标准MACD
        ema_12 = close.ewm(span=12).mean()  # TODO: 将魔法数字提取到配置中
        ema_26 = close.ewm(span=26).mean()  # TODO: 将魔法数字提取到配置中
        dif = ema_12 - ema_26
        dea = dif.ewm(span=9).mean()  # TODO: 将魔法数字提取到配置中
        macd = (dif - dea) * 2
    ...
    def calculate_confidence_Indicator_Base_Indicator(
        ...
        Returns:
            float: 置信度分数 (0-1)
        """
        return 0.8  # ZXM周线MACD置信度较高  # TODO: 将魔法数字提取到配置中
    ...
    def calculate_raw_score_Indicator_Base_Indicator(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        if "DIF" in result.columns and "DEA" in result.columns:
            ...
            score[golden_cross] = 20.0  # TODO: 将魔法数字提取到配置中
            score[death_cross] = -20.0  # TODO: 将魔法数字提取到配置中

            # 背离信号加分
            if "bullish_divergence" in result.columns:
                score[result["bullish_divergence"]] = 30.0  # TODO: 将魔法数字提取到配置中
            if "bearish_divergence" in result.columns:
                score[result["bearish_divergence"]] = -30.0  # TODO: 将魔法数字提取到配置中
    ...
    def _get_default_parameters_zxmweeklymacd(self) -> dict:
        ...
        return {
            ...
            "long_period": 26,  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            "signal_period": 9,  # TODO: 将魔法数字提取到配置中
            "divergence_window": 8,  # TODO: 将魔法数字提取到配置中
        }
