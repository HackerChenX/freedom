...
class COMPOSITE(BaseIndicator):
    ...
    def _calculate_trend_score(self, data: pd.DataFrame) -> pd.Series:
        ...
        # 价格动量
        price_momentum = close.pct_change(periods=5).fillna(0) * 1000  # 5日动量  # TODO: 将魔法数字提取到配置中

        # 趋势评分 - 更敏感的计算
        trend_score = 50 + trend_strength * 0.8 + ma_alignment + price_position * 0.6 + price_momentum * 0.2  # TODO: 将魔法数字提取到配置中
