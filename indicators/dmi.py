...
class DirectionalMovementIndex(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin):
    ...
    def set_parameters_Dmi(self, **kwargs):
        ...
        self.adx_threshold = params.get("adx_threshold", 25.0)  # TODO: 将魔法数字提取到配置中
    ...
    def _calculate_dmi(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # 计算+DM和-DM
        df_copy["+DM"] = np.where(
            (df_copy["up_move"] > df_copy["down_move"]) & (df_copy["up_move"] > 0), df_copy["up_move"], 0
        )
        df_copy["-DM"] = np.where(
    ...
    def identify_patterns_Dmi(self, data: pd.DataFrame, **kwargs) -> List[str]:
        ...
        try:
            ...
            # 3. ADX趋势方向形态  # TODO: 将魔法数字提取到配置中
            if len(recent_adx) >= 5:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                adx_trend = self._detect_adx_trend(recent_adx)
                if adx_trend:
                    patterns.append(f"ADX{adx_trend}")

            # 4. DI线优势形态  # TODO: 将魔法数字提取到配置中
            if current_pdi > current_mdi + 5:  # TODO: 将魔法数字提取到配置中
                patterns.append("DMI多头优势")
            elif current_mdi > current_pdi + 5:  # TODO: 将魔法数字提取到配置中
                patterns.append("DMI空头优势")
            else:
                patterns.append("DMI多空均衡")

            # 5. DMI极值形态  # TODO: 将魔法数字提取到配置中
            if current_pdi > 40:  # TODO: 将魔法数字提取到配置中
                patterns.append("PDI极强")
            elif current_pdi < 10:
                patterns.append("PDI极弱")

            if current_mdi > 40:  # TODO: 将魔法数字提取到配置中
                patterns.append("MDI极强")
            elif current_mdi < 10:
                patterns.append("MDI极弱")

            # 6. DMI背离形态  # TODO: 将魔法数字提取到配置中
            if len(data) >= 20 and len(recent_pdi) >= 10 and len(recent_mdi) >= 10:  # TODO: 将魔法数字提取到配置中
            ...
            # 7. ADX钝化形态  # TODO: 将魔法数字提取到配置中
            if len(recent_adx) >= 5:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                if self._detect_adx_stagnation(
                    recent_adx, threshold=25, periods=5
    ...
    def _calculate_adx_strength_score(self, adx: pd.Series) -> pd.Series:
        ...
        strength_score -= no_trend * 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
    ...
    def _calculate_adx_trend_score(self, adx: pd.Series) -> pd.Series:
        ...
        if len(adx) < 5:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            return trend_score

        # ADX上升趋势+15分
        adx_rising = adx > adx.shift(3)  # TODO: 将魔法数字提取到配置中
        trend_score += adx_rising * 15  # TODO: 将魔法数字提取到配置中

        # ADX下降趋势-10分
        adx_falling = adx < adx.shift(3)  # TODO: 将魔法数字提取到配置中
        trend_score -= adx_falling * 10

        # ADX加速上升+20分
        if len(adx) >= 6:  # TODO: 将魔法数字提取到配置中
            adx_accelerating = adx.diff(3) > adx.shift(3).diff(
                3
            )  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            trend_score += adx_accelerating * 20  # TODO: 将魔法数字提取到配置中
    ...
    def _calculate_di_position_score(self, pdi: pd.Series, mdi: pd.Series) -> pd.Series:
        ...
        # DI线极值评分
        # +DI > 40+15分  # TODO: 将魔法数字提取到配置中
        pdi_extreme_high = pdi > 40  # TODO: 将魔法数字提取到配置中
        position_score += pdi_extreme_high * 15  # TODO: 将魔法数字提取到配置中

        # -DI > 40-15分  # TODO: 将魔法数字提取到配置中
        mdi_extreme_high = mdi > 40  # TODO: 将魔法数字提取到配置中
        position_score -= mdi_extreme_high * 15  # TODO: 将魔法数字提取到配置中
    ...
    def _calculate_adxr_confirm_score(self, adx: pd.Series, adxr: pd.Series) -> pd.Series:
        ...
        # 差距较大+5分
        large_diff = adx_adxr_diff > 5  # TODO: 将魔法数字提取到配置中
        confirm_score += large_diff * 5  # TODO: 将魔法数字提取到配置中
    ...
    def _classify_adx_strength(self, adx_value: float) -> str:
        ...
        if adx_value > 50:  # TODO: 将魔法数字提取到配置中
            return "极强趋势"
        elif adx_value > 40:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            return "很强趋势"
        elif adx_value > 25:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            return "强趋势"
        elif adx_value > 20:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            return "中等趋势"
        elif adx_value > 15:  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            return "弱趋势"
        else:
            return "无趋势"
    ...
    def _detect_adx_trend(self, adx: pd.Series) -> Optional[str]:
        ...
        # 计算ADX趋势
        recent_adx = adx.tail(5)  # TODO: 将魔法数字提取到配置中
        ...
        # 整体下降趋势
        if recent_adx.iloc[-1] < recent_adx.iloc[0] * 0.9:  # TODO: 将魔法数字提取到配置中
            return "下降趋势"
    ...
    def _detect_dmi_divergence_pattern(self, price: pd.Series, pdi: pd.Series, mdi: pd.Series) -> Optional[str]:
        ...
        recent_pdi = pdi.tail(20)  # TODO: 将魔法数字提取到配置中
        recent_mdi = mdi.tail(20)  # TODO: 将魔法数字提取到配置中
    ...
    def get_patterns_Dmi(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        # ADX趋势强度
        patterns_df["ADX_STRONG_TREND"] = adx > 25  # TODO: 将魔法数字提取到配置中
        patterns_df["ADX_WEAK_TREND"] = adx < 20  # TODO: 将魔法数字提取到配置中
    ...
    def calculate_confidence_Dmi(self, score: pd.Series, patterns: pd.DataFrame, signals: dict) -> float:
        ...
        # 3. 基于ADX强度的置信度  # TODO: 将魔法数字提取到配置中
        if hasattr(self, "_result") and self._result is not None and "ADX" in self._result.columns:
            try:
                ...
                if len(adx_values) > 0:
                    ...
                    elif last_adx < 15:  # TODO: 将魔法数字提取到配置中
                        confidence -= 0.1
            except:
                pass
    ...
    def get_pattern_info_Dmi(self, pattern_id: str) -> dict:
        ...
        return pattern_info_map.get(
            pattern_id,
            {"name": pattern_id, "description": f"DMI形态: {pattern_id}", "strength": "medium", "type": "neutral"},
        )
    ...
    def get_patterns(self, data: pd.DataFrame = None, **kwargs) -> pd.DataFrame:
        ...
        patterns_df["DMI_STRONG_TREND"] = adx > 25  # TODO: 将魔法数字提取到配置中

        # 2. 弱趋势形态 (ADX < 20)  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_WEAK_TREND"] = adx < 20  # TODO: 将魔法数字提取到配置中

        # 3. 上升趋势形态 (PDI > MDI and ADX > 20)  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_UPTREND"] = (pdi > mdi) & (adx > 20)  # TODO: 将魔法数字提取到配置中

        # 4. 下降趋势形态 (MDI > PDI and ADX > 20)  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_DOWNTREND"] = (mdi > pdi) & (adx > 20)  # TODO: 将魔法数字提取到配置中

        # 5. PDI上穿MDI形态  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_PDI_CROSS_UP"] = (pdi > mdi) & (pdi.shift(1) <= mdi.shift(1))

        # 6. MDI上穿PDI形态  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_MDI_CROSS_UP"] = (mdi > pdi) & (mdi.shift(1) <= pdi.shift(1))

        # 7. ADX上升形态  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_ADX_RISING"] = adx > adx.shift(1)

        # 8. ADX下降形态  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_ADX_FALLING"] = adx < adx.shift(1)

        # 9. 极强趋势形态 (ADX > 40)  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_VERY_STRONG_TREND"] = adx > 40  # TODO: 将魔法数字提取到配置中

        # 10. 无趋势形态 (ADX < 15)  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_NO_TREND"] = adx < 15  # TODO: 将魔法数字提取到配置中

        # 11. 趋势转换形态  # TODO: 将魔法数字提取到配置中
        patterns_df["DMI_TREND_CHANGE"] = ((pdi > mdi) & (pdi.shift(1) <= mdi.shift(1))) | (
    ...
    def calculate_raw_score(self, data: pd.DataFrame, **kwargs) -> pd.Series:
        ...
        score -= no_trend * 15  # TODO: 将魔法数字提取到配置中

        # 3. 基于交叉信号的评分  # TODO: 将魔法数字提取到配置中
        # PDI上穿MDI加分
        pdi_cross_up = (pdi > mdi) & (pdi.shift(1) <= mdi.shift(1))
        score += pdi_cross_up * 12  # TODO: 将魔法数字提取到配置中
    ...
    def get_signals(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        # 1. PDI上穿MDI买入信号
        pdi_cross_up = (pdi > mdi) & (pdi.shift(1) <= mdi.shift(1))
        strong_trend_up = pdi_cross_up & (adx > 20)  # TODO: 将魔法数字提取到配置中
        result_df.loc[strong_trend_up, "dmi_signal"] = 1
        result_df.loc[strong_trend_up, "dmi_strength"] = 0.8  # TODO: 将魔法数字提取到配置中
        result_df.loc[strong_trend_up, "dmi_confidence"] = 0.9  # TODO: 将魔法数字提取到配置中

        # 2. MDI上穿PDI卖出信号
        mdi_cross_up = (mdi > pdi) & (mdi.shift(1) <= pdi.shift(1))
        strong_trend_down = mdi_cross_up & (adx > 20)  # TODO: 将魔法数字提取到配置中
        result_df.loc[strong_trend_down, "dmi_signal"] = -1
        result_df.loc[strong_trend_down, "dmi_strength"] = 0.8  # TODO: 将魔法数字提取到配置中
        result_df.loc[strong_trend_down, "dmi_confidence"] = 0.9  # TODO: 将魔法数字提取到配置中

        # 3. 强趋势确认信号  # TODO: 将魔法数字提取到配置中
        very_strong_up = (pdi > mdi) & (adx > 40)  # TODO: 将魔法数字提取到配置中
        result_df.loc[very_strong_up, "dmi_signal"] = 1
        result_df.loc[very_strong_up, "dmi_strength"] = 0.9  # TODO: 将魔法数字提取到配置中
        result_df.loc[very_strong_up, "dmi_confidence"] = 0.95  # TODO: 将魔法数字提取到配置中

        very_strong_down = (mdi > pdi) & (adx > 40)  # TODO: 将魔法数字提取到配置中
        result_df.loc[very_strong_down, "dmi_signal"] = -1
        result_df.loc[very_strong_down, "dmi_strength"] = 0.9  # TODO: 将魔法数字提取到配置中
        result_df.loc[very_strong_down, "dmi_confidence"] = 0.95  # TODO: 将魔法数字提取到配置中

        # 4. 趋势减弱警告信号  # TODO: 将魔法数字提取到配置中
        trend_weakening = (adx < adx.shift(1)) & (adx.shift(1) > 30)  # TODO: 将魔法数字提取到配置中
        result_df.loc[trend_weakening, "dmi_signal"] = 0
        result_df.loc[trend_weakening, "dmi_strength"] = 0.3  # TODO: 将魔法数字提取到配置中
        result_df.loc[trend_weakening, "dmi_confidence"] = 0.6  # TODO: 将魔法数字提取到配置中
    ...
    def calculate_score(self, data: pd.DataFrame, **kwargs) -> dict:
        ...
        # 基于ADX强度计算置信度
        if adx > 40:  # TODO: 将魔法数字提取到配置中
            confidence = 0.95  # 极强趋势  # TODO: 将魔法数字提取到配置中
        elif adx > 25:  # TODO: 将魔法数字提取到配置中
            confidence = 0.8  # 强趋势  # TODO: 将魔法数字提取到配置中
        elif adx > 20:  # TODO: 将魔法数字提取到配置中
            confidence = 0.6  # 中等趋势  # TODO: 将魔法数字提取到配置中
        elif adx > 15:  # TODO: 将魔法数字提取到配置中
        ...
        # 基于PDI和MDI差值调整置信度
        di_diff = abs(pdi - mdi)
        if di_diff > 20:  # TODO: 将魔法数字提取到配置中
            confidence += 0.1
        elif di_diff > 10:
        ...
        return {
            ...
            "signals": {
                ...
                "strength": (
                    "strong" if adx > 25 else "weak" if adx < 20 else "medium"
                ),  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            },
        }
    ...
    def set_parameters(self, **kwargs):
        ...
        if "period" in kwargs:
            ...
            if (
                isinstance(period, int) and 5 <= period <= 50
            ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                self.period = period
            else:
        ...
        if "adx_period" in kwargs:
            ...
            if (
                isinstance(adx_period, int) and 5 <= adx_period <= 50
            ):  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        ...
        if "adx_threshold" in kwargs:
            ...
            if isinstance(adx_threshold, (int, float)) and 10 <= adx_threshold <= 50:  # TODO: 将魔法数字提取到配置中
