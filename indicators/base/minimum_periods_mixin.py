...
1. 每个指标明确定义最小数据要求
2. 统一的数据验证机制
3. 避免因数据不足导致的计算错误  # TODO: 将魔法数字提取到配置中
4. 为双向验证提供准确的数据窗口参考  # TODO: 将魔法数字提取到配置中
"""
...
class MinimumPeriodsMixin(ABC):
    ...
    def recommended_periods(self) -> int:
        ...
        Returns:
            int: 推荐的数据周期数
        """
        return max(self.minimum_periods * 2, 60)  # 至少60个周期  # TODO: 将魔法数字提取到配置中
    ...
    def stable_periods(self) -> int:
        ...
        """
        return max(
            self.minimum_periods * 3, 120
        )  # 至少120个周期  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
...
def get_indicator_minimum_periods_mapping() -> Dict[str, int]:
    ...
    return {
        # 核心指标 (P0)
        "MACD": 35,  # 慢线26 + 信号线9 = 35  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "RSI": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "KDJ": 18,  # K周期9 + D周期3 + 缓冲6 = 18  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "BOLL": 25,  # 周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "MA": 25,  # 周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "EMA": 25,  # 周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        # 重要指标 (P1)
        "ATR": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "CCI": 25,  # 周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "MFI": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "OBV": 10,  # 累积指标，最小10个周期
        "STOCHRSI": 25,  # RSI14 + Stoch14 = 28，取25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "AROON": 30,  # 周期25 + 缓冲5 = 30  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "ICHIMOKU": 55,  # 基准线26 + 转换线9 + 先行线52 = 55  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        # 常用指标 (P2)
        "SAR": 15,  # 抛物线转向，最小15个周期  # TODO: 将魔法数字提取到配置中
        "ADX": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "WMA": 25,  # 周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "VORTEX": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "EMV": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "TRIX": 35,  # 三重指数平滑，需要更多数据  # TODO: 将魔法数字提取到配置中
        "CMO": 20,  # 周期14 + 缓冲6 = 20  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "ROC": 15,  # 周期12 + 缓冲3 = 15  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        # 专业指标 (P3)
        "KC": 25,  # 基于ATR，周期20 + 缓冲5 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        "VIX": 30,  # 波动率指标，需要更多数据  # TODO: 将魔法数字提取到配置中
        "VOLUME_RATIO": 15,  # 成交量比率，最小15个周期  # TODO: 将魔法数字提取到配置中
        "ENHANCED_CCI": 30,  # 增强CCI，需要更多数据  # TODO: 将魔法数字提取到配置中
        "ENHANCED_DMI": 25,  # 增强DMI，周期14 + 缓冲11 = 25  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
        # ZXM系列指标 (P4) - 通常需要更多数据
        "ZXM_WEEKLY_MACD": 50,  # 周线MACD，需要更多数据  # TODO: 将魔法数字提取到配置中
        "ZXM_MONTHLY_MACD": 100,  # 月线MACD，需要更多数据
        "ZXM_TREND_SCORE": 60,  # 趋势评分，综合指标  # TODO: 将魔法数字提取到配置中
        "ZXM_MARKET_SENTIMENT": 40,  # 市场情绪，需要足够样本  # TODO: 将魔法数字提取到配置中
        "ZXM_FUND_FLOW": 30,  # 资金流向分析  # TODO: 将魔法数字提取到配置中
        # 系统分析指标 (P5)
        "COMPOSITE_SCORE": 60,  # 综合评分，需要多个指标  # TODO: 将魔法数字提取到配置中
        "PATTERN_RECOGNITION": 40,  # 形态识别，需要足够样本  # TODO: 将魔法数字提取到配置中
        "RISK_ASSESSMENT": 50,  # 风险评估，需要历史数据  # TODO: 将魔法数字提取到配置中
    }
...
def validate_all_indicators_periods() -> Dict[str, Dict[str, Any]]:
    ...
    for indicator_name, min_periods in mapping.items():
        validation_results[indicator_name] = {
            ...
            "recommended_periods": max(min_periods * 2, 60),  # TODO: 将魔法数字提取到配置中
            "stable_periods": max(min_periods * 3, 120),  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
...
def get_unified_data_window_for_validation(indicator_names: list) -> int:
    ...
    # 确保至少120个周期，最多300个周期
    return min(max(max_stable_periods, 120), 300)  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
    ...
    for group_name, indicators in priority_groups.items():
        ...
        for indicator in indicators:
            if indicator in validation_results:
                ...
                print(
                    f"  {indicator:20} 最小:{result['minimum_periods']:3d} 推荐:{result['recommended_periods']:3d} 稳定:{result['stable_periods']:3d}"
                )  # TODO: 将魔法数字提取到配置中
