...
class TREND_CLASSIFICATION(BaseIndicator, PatternSignalMixin):
    """
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        Returns:
            添加了TREND_CLASSIFICATION指标的DataFrame
        """
    ...
    def _calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        df[f'TREND_CLASSIFICATION_VALUE'] = df['close'].rolling(window=self.period).mean()
