...
class MarketEnv(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin):
    """
    MARKET_ENV 指标
    ...
    def calculate_Env(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        Returns:
            添加了MARKET_ENV指标的Data_frame
        """
        result = self._calculate_marketenv(data, **kwargs)
        self._result = result
        return result
