...
class PatternQualityEvaluator(BaseIndicator, PatternSignalMixin, MinimumPeriodsMixin):
    """
    形态质量评估指标
    ...
    def _calculate_patternqualityevaluator(self, data):
        ...
        if len(result) > 30:  # TODO: 将魔法数字提取到配置中
            # 设置几个高质量形态
            result.iloc[15:20, result.columns.get_indexer(["pattern_quality"])[0]] = (
                85.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )
            result.iloc[15:20, result.columns.get_indexer(["reliability_score"])[0]] = (
                80.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )
            result.iloc[15:20, result.columns.get_indexer(["profit_potential"])[0]] = (
                75.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )

            result.iloc[45:50, result.columns.get_indexer(["pattern_quality"])[0]] = (
                65.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )
            result.iloc[45:50, result.columns.get_indexer(["reliability_score"])[0]] = (
                60.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )
            result.iloc[45:50, result.columns.get_indexer(["profit_potential"])[0]] = (
                70.0  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            )
    ...
    def get_patterns_Evaluator(self, data):
        ...
        patterns = pd.DataFrame(
            {
                "pattern_name": ["头肩顶", "双底"],
                "start_idx": [15, 45],  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                "end_idx": [20, 50],  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                "pattern_quality": [85.0, 65.0],  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                "reliability_score": [80.0, 60.0],  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
                "profit_potential": [75.0, 70.0],  # TODO: 将魔法数字提取到配置中  # TODO: 将魔法数字提取到配置中
            }
        )
    ...
    def minimum_periods(self) -> int:
        """
        PatternQualityEvaluator指标所需的最少数据周期数
