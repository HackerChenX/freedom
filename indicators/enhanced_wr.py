...
class ENHANCED_WR(BaseIndicator, PatternSignalMixin):
    ...
    def _calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        df[f'ENHANCED_WR_VALUE'] = df['close'].rolling(window=self.period).mean()
        ...
        df.loc[:, 'buy_signal'] = df[f'ENHANCED_WR_VALUE'] >= score_threshold
        df.loc[:, 'sell_signal'] = df[f'ENHANCED_WR_VALUE'] < score_threshold
        df.loc[:, 'hold_signal'] = df[f'ENHANCED_WR_VALUE'] < score_threshold
