...
class FIBONACCI_TOOLS(BaseIndicator, PatternSignalMixin):
    ...
    def _calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        df.loc[:, 'buy_signal'] = df[f'FIBONACCI_TOOLS_VALUE'] >= score_threshold
        df.loc[:, 'sell_signal'] = df[f'FIBONACCI_TOOLS_VALUE'] < score_threshold
        df.loc[:, 'hold_signal'] = df[f'FIBONACCI_TOOLS_VALUE'] < score_threshold
